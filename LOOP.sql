...
BEGIN 
    ...
    FOR i IN 1..value_of_iteration LOOP 
        ...
        INSERT INTO CRIMINAL (city_name, shoot_id, name_, date_, manner_of_death, armed, age, gender_name) 
            VALUES ('Golden Shores', 2335, 'Drey Krause',  TO_DATE(:date_,'13-02-17'),	'shot', 'gun',	53, 'M'); 
        INSERT INTO Criminal (city_name, shoot_id, name_, date_, manner_of_death, armed, age, gender_name) 
            VALUES ('Topeka', 377, 'Richard Reed',  TO_DATE(:date_,'10-04-15'),	'shot', 'gun',	38, 'M'); 
        INSERT INTO CRIMINAL (city_name, shoot_id, name_, date_, manner_of_death, armed, age, gender_name) 
            VALUES ('Topeka', 1344, 'Randall J. Selsor',  TO_DATE(:date_,'07-03-16') ,	'shot', 'undetermined',	45, 'M'); 
        INSERT INTO CRIMINAL (city_name, shoot_id, name_, date_, manner_of_death, armed, age, gender_name) 
            VALUES ('Topeka', 3202, 'Dominique Tyrell White',  TO_DATE(:date_,'28-09-17') , 'shot', 'gun', 30, 'M'); 
